...
// Define CLI
function parseStoreIoncubeEncodeOption(suppliedValue) {
...
if (![true, false, 'auto'].includes(Program.storeIoncubeEncode)) {
    console.error(Chalk.white.bgRed.bold(`Invalid value '${Program.storeIoncubeEncode}' for option --store-ioncube-encode.`));
    process.exit(1);
}
