...
if (![true, false, 'auto'].includes(Program.licenseCheckRequired)) {
    console.error(Chalk.white.bgRed.bold(`Invalid value '${Program.licenseCheckRequired}' for option --license-check-required.`));
    process.exit(1);
}
