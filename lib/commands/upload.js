...
async function main() {
    ...
    try {
        ...
        plugin.latestBinary.changelogs.forEach((changelog) => {
            ...
            // Add 20 non-breaking whitespace characters to the changelog. This allows the changelog to pass
            // Shopware's server-side validation, which accepts only changelogs with at least 20 characters.
