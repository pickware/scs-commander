...
async function main() {
    ...
    try {
        ...
        if (Program.storeIoncubeEncode === 'auto') {
            // Determine whether the currently latest binary is ionCube-encoded
            ...
            if (releasedBinaries.length > 0) {
                Program.storeIoncubeEncode = releasedBinaries[0].ionCubeEncrypted;
            }
        }
