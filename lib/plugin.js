...
function readVersionInfoFromComposerJson(composerJsonString) {
...
function readVersionInfoFromPluginJson(pluginJsonString) {
...
module.exports = class Plugin {
    static async readFromZipFile(zipFilePath) {
        ...
        if (sw5RootFolder) {
            ...
            Object.assign(plugin, readVersionInfoFromPluginJson(
            ...
            Object.assign(plugin, readVersionInfoFromComposerJson(
