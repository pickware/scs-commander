...
const defaultMappings = {
    ...
    releaseEventURL: 'SCS_RELEASE_EVENT_ENDPOINT',
};
...
module.exports = {
    ...
    loadConfig(program, argumentMappings) {
        ...
        // Reset the password set in the porogram, if the passed username and the one now in the program don't match.
        // This allows to overwrite the account to be used, even if all account data is set in the .env file.
        if (originalUsername && originalUsername.length > 0 &&
